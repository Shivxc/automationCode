...
public class mck2 extends base{
	...
	public void auctionmarket() throws Exception {
		...
		ui.type("//input[@title='Side']", "SELL");
		ui.click("//*[text()='SELL']");
		ui.type("//input[@title='Market Code']", "MCK2");
		ui.click("//li[contains(text(),'MCK2 - MOCK MARKET 2')]");
		ui.type("//input[@title='Commodity Code']", "MOCKREV - MOCKREV");
		ui.click("//*[contains(text(),'MOCKREV - MOCKREV')]");
		Thread.sleep(1000);
		ui.type("//input[@title=' Contract Code']", "UJFWD - FORWARD AUCTION");
		ui.click("//li[contains(text(),'UJFWD - FORWARD AUCTION')]");
		Thread.sleep(1000);
